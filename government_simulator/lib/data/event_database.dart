    ...
    GameEvent(
      ...
      choices: [
        Choice(
          ...
          impact: Impact(gdpChange: -1.2, satisfactionChange: -18, stabilityChange: 10, inflationChange: -0.5),
        ),
        Choice(
          id: 'eco_01_b',
          text: '法人税を減税する',
          shortDescription: '投資↑ | GDP↑ | 格差↑',
          impact: Impact(gdpChange: 2.5, satisfactionChange: -8, nationalPowerChange: 5, stabilityChange: -5),
        ),
        Choice(
          id: 'eco_01_c',
          text: '消費税を引き上げる',
          shortDescription: '財政収入↑ | 消費↓ | 低所得層打撃',
          impact: Impact(gdpChange: -0.8, satisfactionChange: -22, stabilityChange: 8, inflationChange: 1.5),
        ),
        Choice(
          id: 'eco_01_d',
          text: '税制を現状維持する',
    ...
    GameEvent(
      ...
      choices: [
        Choice(
          ...
          impact: Impact(gdpChange: 1.5, unemploymentChange: -2.0, satisfactionChange: 12, stabilityChange: 8, nationalPowerChange: 5),
        ),
        Choice(
          id: 'eco_04_b',
          text: '段階的な投資に縮小する',
          shortDescription: '財政負担軽減 | 効果は中程度',
          impact: Impact(gdpChange: 0.5, unemploymentChange: -0.8, satisfactionChange: 5, stabilityChange: 4),
        ),
        Choice(
          id: 'eco_04_c',
          text: '民間に委託する',
          shortDescription: 'コスト削減 | 公共性↓',
          impact: Impact(gdpChange: 0.8, satisfactionChange: -5, stabilityChange: 2),
        ),
      ],
    ),
    ...
    GameEvent(
      ...
      choices: [
        Choice(
          ...
          impact: Impact(gdpChange: -2.5, satisfactionChange: -25, stabilityChange: 12, unemploymentChange: 2.0),
        ),
        Choice(
          id: 'eco_08_b',
          text: '成長で乗り越える戦略をとる',
          shortDescription: 'GDP↑目標 | リスク継続',
          impact: Impact(gdpChange: 2.0, nationalPowerChange: 3, stabilityChange: -10),
        ),
        Choice(
          id: 'eco_08_c',
          text: 'IMFに支援を要請する',
          shortDescription: '緊急支援 | 主権制約 | 信頼↓',
          impact: Impact(stabilityChange: 15, satisfactionChange: -30, nationalPowerChange: -15, gdpChange: -1.0),
        ),
      ],
    ),
    ...
    GameEvent(
      ...
      choices: [
        Choice(
          id: 'eco_09_a',
          text: '富裕税を新設する',
          shortDescription: '格差改善 | 資本逃避リスク | 一般層支持↑',
          impact: Impact(satisfactionChange: 18, gdpChange: -0.8, stabilityChange: 5, nationalPowerChange: -3),
        ),
        Choice(
          id: 'eco_09_b',
          text: 'キャピタルゲイン税を強化する',
          shortDescription: 'バランス型 | 投資意欲↓',
          impact: Impact(satisfactionChange: 10, gdpChange: -0.4, stabilityChange: 3),
        ),
        Choice(
          id: 'eco_09_c',
          text: '課税強化を見送る',
    ...
    GameEvent(
      ...
      choices: [
        Choice(
          ...
          impact: Impact(satisfactionChange: 22, gdpChange: -1.5, stabilityChange: 5, nationalPowerChange: 3),
        ),
        Choice(
          id: 'soc_02_b',
          text: '予防医療に転換して効率化',
          shortDescription: '長期的コスト↓ | 即効性なし',
          impact: Impact(satisfactionChange: 8, gdpChange: 0.2, stabilityChange: 6, nationalPowerChange: 5),
        ),
        Choice(
          id: 'soc_02_c',
          text: '自己負担割合を引き上げる',
          shortDescription: '財政改善 | 満足度↓↓',
          impact: Impact(satisfactionChange: -25, stabilityChange: 10, gdpChange: -0.5),
        ),
      ],
    ),
    ...
    GameEvent(
      ...
      choices: [
        Choice(
          ...
          impact: Impact(satisfactionChange: 20, gdpChange: -1.5, inflationChange: -1.0, stabilityChange: -3),
        ),
        Choice(
          id: 'ext_04_b',
          text: '省エネ政策と需要削減を推進',
    ...
    GameEvent(
      ...
      choices: [
        ...
        Choice(
          ...
          impact: Impact(nationalPowerChange: 5, gdpChange: -0.3, satisfactionChange: 3, stabilityChange: 3),
        ),
        Choice(
          id: 'mil_01_c',
          text: '防衛費を削減して社会に回す',
          shortDescription: '社会保障↑ | 安全保障リスク',
          impact: Impact(satisfactionChange: 15, gdpChange: 0.5, nationalPowerChange: -8, stabilityChange: -3),
        ),
      ],
    ),
